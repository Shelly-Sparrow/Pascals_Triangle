...
endmessage1 = 'This output has been saved under'
...
while restart == 0:
	...
	print("==================================================================")
	print("Calculating a large numbers of rows will take considerable time,")
	print("which will be affected by your hardware's capability.")
	print("")
	print("")
	...
	usernumber = input("Rows needed (integer only): ")
	print("Working...")
